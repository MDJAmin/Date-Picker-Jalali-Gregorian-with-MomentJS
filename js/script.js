...
// function updateCurrentDay() {
//   const currentDay = moment().format("dddd, MMMM Do YYYY");
//   document.querySelector(".current").textContent = `Current day is : ${currentDay}`;
// }
...
//   /
//   if (useJalaali) {
//     currentDate = moment(currentDate.format("YYYY-MM-DD"), "YYYY-MM-DD").format("jYYYY/jMM/jDD");
//   } else {
//     currentDate = moment(currentDate.format("jYYYY/jMM/jDD"), "jYYYY/jMM/jDD").format("YYYY-MM-DD");
//   }
